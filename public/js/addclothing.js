...
document.addEventListener("DOMContentLoaded", function() {
    ...
    form.addEventListener("submit", function(event) {
      ...
      var typeSelect = document.getElementById("clothingType");
      var selectedType = typeSelect.options[typeSelect.selectedIndex].value;
  
      // Get the selected clothing color
      var colorInput = document.getElementById("clothingColor");
      var selectedColor = colorInput.value;
  
      // Get the clothing description
      var descriptionInput = document.getElementById("clothingDescription");
